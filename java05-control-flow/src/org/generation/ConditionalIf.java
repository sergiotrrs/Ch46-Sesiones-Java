...
public class ConditionalIf {
	...
	public static void main(String[] args) {
		/**
		 * 
		 * Flujos de control: las sentencias de flujo de control
		 * interrumpen el flujo de ejecusión empleando toma
		 * de decisiones, bucles y ramificaciones lo que permite
		 * que el programa ejecute condicionalmente bloques de código
		 * particulares.
		 * 
		 ...
		 */
		int age = 15;
		if( age >= 18 ) System.out.println("Puede Votar");
		 ...
		 */
		int myNum = 0;
		if( myNum >= 1 && myNum <= 10  ) System.out.println("Está en el rango");
		else System.out.println("Fuera de rango");
		
		
		if( myNum == 15)/* sentencia */ ; // el ; termina la evaluación de if
